    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-center font-mono text-sm lg:flex">
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          <div className="flex place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0">
            By{' '}
            <span className="font-bold">CoinConductor</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative flex place-items-center my-16">
        <h1 className="text-6xl font-bold text-center">
          Welcome to <span className="text-primary-600">CoinConductor</span>
        </h1>
      </div>
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-left gap-8">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Create a new account to start budgeting.
          </p>
        </Link>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Try out CoinConductor with a demo account.
          </p>
        </Link>
      </div>
    </main>
